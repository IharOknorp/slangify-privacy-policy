...
Ad interaction data (e.g., ad impressions and clicks)
...
We process personal data based on our legitimate interest in analyzing app usage, improving the App, and displaying advertisements.
...
Google may process personal data outside the European Economic Area (EEA). In such cases, appropriate safeguards are applied, such as Standard Contractual Clauses (SCCs).

Data Retention

We retain analytics and advertising data only for as long as necessary to fulfill the purposes described above, or as configured in the Firebase Analytics and AdMob settings.
...
To exercise these rights, please contact us at oknorpcorp@gmail.com
.
